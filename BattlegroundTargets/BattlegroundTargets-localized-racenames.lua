...
elseif locale == "ruRU" then
	BattlegroundTargets_RaceNames = {
		...
		["Эльфийка крови"] = HORDE,
		["Эредар"] = HORDE,
		["Ночнорожденный"] = HORDE,
		["Ночнорожденная"] = HORDE,
		["Вульпера (Орда)"] = HORDE,
		["Вульпера (Альянс)"] = ALLIANCE,
		["Пандарен (Альянс)"] = ALLIANCE,
		["Пандарен (Орда)"] = HORDE,
		["Дворф Черного Железа"] = ALLIANCE,
		["Эльф Бездны"] = ALLIANCE,
		["Высший эльф"] = ALLIANCE,
		["Ворген"] = ALLIANCE,
		["Эльфийка Бездны"] = ALLIANCE,
