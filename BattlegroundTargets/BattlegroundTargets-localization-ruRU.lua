...
BattlegroundTargets_Localization:CreateLocaleTable({
    ...
    ["Healers data will now be deleted from the database after "] = "Данные о хилах теперь будут удаляться через " ,
    ["months. You need to re-login to save settings."] = "мес. Перезайдите на персонажа (relog) чтобы сохранить изменения.", 
    ["Current storage period of data is: "] = "Текущий срок хранения данных: ",
    [" months. Max period is 11 months."] = " мес. Максимальный период: 11 месяцев.",
