...
, ["Healers data will now be deleted from the database after "] = true, ["months. You need to re-login to save settings."] = true
, ["Current storage period of data is: "] = true, [" months. Max period is 11 months."] = true
